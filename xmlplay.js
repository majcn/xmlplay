...
function dolayout (abctxt) {
    ...
    if (fplay) {
        ...
        mLib.doModel (Abc, abctxtTemp, opt, gTempo=120, debug, mapTab, logerr);
    ...
    mLib.doLayout ( Abc, abctxt, opt, null, fplay, abcElm, logerr, addUnlockListener, 
...
async function init(parms) {
    ...
    document.getElementById("panel-button").addEventListener ('click', evt => mbarklik (evt));
